function calcularAreaTriangulo() {
  ...
  const altura = parseFloat(prompt("Imforme a altura do Triangulo: "));
...
function calcularAreaTrapezio() {
  const baseMaior = parseFloat(prompt("Infome o lado Maior do Trapezio: "));
  const baseMenor = parseFloat(prompt("Informe lado menor do Trapezio: "));
