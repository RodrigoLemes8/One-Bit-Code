...
var median = function median() {
  ...
  var fristMedian = orderedNumbers[middle - 1];
  var secoundMedian = orderedNumbers[middle];
  return average(fristMedian, secoundMedian);
};
...
console.log("Moda: ".concat(mode(1, 6, 1, 6, 5, 6, 4, 9, 7, 6, 4, 6, 3, 3, 6, 5, 5, 5, 2, 4, 0, 4)));